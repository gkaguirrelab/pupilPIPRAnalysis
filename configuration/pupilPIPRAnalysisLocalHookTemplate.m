function pupilPIPRAnalysisLocalHook
%
...
%% Say hello
fprintf('* Running pupilPIPRAnalysisLocalHook...');

%% Set preferences

% Find the project directory, add it to the path, save this as a
%  pref, and then make this the current directory
projectDir = fullfile(tbLocateProject('pupilPIRPAnalysis'));
addpath(genpath(projectDir));
setpref('pupilPIPRAnalysis', 'projectDir', projectDir);
