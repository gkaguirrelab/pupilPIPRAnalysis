...
% make our experimental/sick group, we are applying a 10% reduction to the
...
alpha = 0.01;
effectSize = 0.1; % the idea we're running with for now is that the true effect of disease is a 10% reduction in the magnitude of the persistent component
