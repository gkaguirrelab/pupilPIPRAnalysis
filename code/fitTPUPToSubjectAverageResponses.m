...
for session = 1:2;
    ...
    for stimulation = 1:length(stimulusOrder)
        ...
        if stimulation == 1
            ...
            plot(timebase/1000, averageLMSFit{session}(1,:))
            xlabel('Time (s)')
            ylabel('Pupil Diameter (% Change)')
        ...
        elseif stimulation == 2
            ...
            hold on
            plot(timebase/1000, modelResponseStruct.values)
            plot(timebase/1000, averageMelFit{session}(1,:))
        ...
        elseif stimulation == 3
            ...
            hold on
            plot(timebase/1000, modelResponseStruct.values)
            plot(timebase/1000, averageBlueFit{session}(1,:))
            legend('Group Data', 'TPUP Fit', 'Average Fit')
        ...
        elseif stimulation == 4
            ...
            hold on
            plot(timebase/1000, modelResponseStruct.values)
            plot(timebase/1000, averageRedFit{session}(1,:))
            legend('Group Data', 'TPUP Fit', 'Average Fit')
